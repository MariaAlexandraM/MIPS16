...
namespace eval ::optrace {
  variable script "H:/Facultate_Maria/an2_sem2/AC/MIPS16/test_env/test_env.runs/impl_1/test_env.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet H:/Facultate_Maria/an2_sem2/AC/MIPS16/test_env/test_env.runs/synth_1/test_env.dcp
